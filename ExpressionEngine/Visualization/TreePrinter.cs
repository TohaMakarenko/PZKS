...
namespace ExpressionEngine.Visualization
{
    public static class TreePrinter
    {
        ...
        {
            if (node is NodeBinary binaryNode)
            ...
            if (node is NodeNumber nodeNumber)
                return nodeNumber.Number.ToString();
            if (node is NodeVariable nodeVariable)
                return nodeVariable.VariableName;
            return string.Empty;
        }
    }
}